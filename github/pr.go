...
// ListPullRequestCommits returns all commits in a pull request
func (g *GitHub) ListPullRequestCommits(ctx context.Context, owner, repo string, number int) ([]*github.RepositoryCommit, error) {
